...
def main(dataset_name=None):
    ...
    files = '/home/data/juliuxue/data/iHarmony4_data/HAdobe5k/'+'HAdobe5k_test.txt'
    ...
    with open(files, 'r') as f:
        for line in f.readlines():
            ...
            path ='/home/data/juliuxue/code/HDNet-main/HDNet-main/evaluate/59/results/HAdobe5k/'
            real_path=os.path.join(path, name+'_real.png')
            mask_path = os.path.join(path, name+'_mask.png')
            harmonized_path = os.path.join(path, name+'_pre.png')
    ...
    for i, harmonized_path in enumerate(tqdm(harmonized_paths)):
        ...
        fmse_score = torch.nn.functional.mse_loss(harmonized * mask, real * mask) * 1024 * 1024 / fore_area
    ...
    print(count)
    mean_sore = " MSE %0.2f | PSNR %0.2f | SSIM %0.4f |fMSE %0.2f | fPSNR %0.2f | fSSIM %0.4f" % (
     mse_scores_mu, psnr_scores_mu, ssim_scores_mu, fmse_scores_mu, fpsnr_scores_mu, fssim_score_mu)
    print(mean_sore)
